...
Screenshots live under [`docs/screenshots/`](screenshots/). Drop a new PNG (or JPG) in there matching the filename below, and it'll show up here.
...
![Encyclopedia: Suggest a Bag form](screenshots/encyclopedia-suggest.png)
...
![Encyclopedia detail page](screenshots/encyclopedia-detail.png)
...
![Admin: Log a Bag](screenshots/admin-log-a-bag.png)
...
![Admin: Edit Mode list](screenshots/admin-edit-list.png)

![Admin: Edit Mode editing an entry](screenshots/admin-edit-form.png)
...
![Admin: Settings — Category Visibility](screenshots/admin-settings.png)
...
![Hidden playlist on About](screenshots/easter-egg-playlist.png)
